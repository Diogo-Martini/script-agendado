...
params_base = {
    ...
    'CAMPOS': (
        ...
        'horas_lancadas,stat_cnt_16,stat_cnt_100,stat_cnt_5017,oco_status_simples,vencimento_sla_solucao,vencimento_sla_resposta'
    ),
...
colunas = [
    ...
    "Status (sem tempo decorrido)", "Data de Vencimento do SLA de Solução",  "Data de Vencimento do SLA de Resposta"
]
...
if not df_novo.empty:
    ...
    df_novo = df_novo.rename(columns={
        ...
        "oco_status_simples": "Status (sem tempo decorrido)", "vencimento_sla_solucao": "Data de Vencimento do SLA de Solução",
         "vencimento_sla_resposta": "Data de Vencimento do SLA de Resposta"
    })[colunas]
